    ...
    public class DbInitializer : IDbInitializer
    {
        ...
        public void Initialize()
        {
            ...
            if (!_roleManager.RoleExistsAsync(SD.KitchenRole).GetAwaiter().GetResult())
            {
                ...
                {
                    UserName = "tnpich@nestorsystems.com",
                    Email = "tnpich@nestorsystems.com",
                    FirstName = "Nestor",
                    LastName = "Pich"
                }, "Admin123$").GetAwaiter().GetResult();

                ApplicationUser user = _db.ApplicationUser.FirstOrDefault(u => u.Email == "tnpich@nestorsystems.com");
